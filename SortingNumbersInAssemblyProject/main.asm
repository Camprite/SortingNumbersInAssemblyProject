...
_DATA SEGMENT
	...
	fileReadInvalidArgument DB 0Dh,0Ah,"Nie uda³o siê otworzyæ pliku, spróbuj ponownie.",0,0Ah
	ALIGN	4
	sizeFileReadInvalidArgument DD	$ - fileReadInvalidArgument ;liczba znaków w tablicy
		
	badRangeError DB 0Dh,0Ah,"Podany zakres jest nieprawid³owy.",0,0Ah
	ALIGN	4
	sizeBadRangeError DD	$ - badRangeError ;liczba znaków w tablicy
	
	sortedSuccessful DB 0Dh,0Ah,"Plik zosta³ pomyœlnie posortowany.",0,0Ah
	ALIGN	4
	sizeSortedSuccessful DD	$ - sortedSuccessful ;liczba znaków w tablicy
	...
	rangeMsg3 DB 0Dh,0Ah,"Podaj ile liczb ma zostaæ wylosowanych oraz zapisanych (Zakres 1 - 255) :  ",0,0Ah
	ALIGN	4
